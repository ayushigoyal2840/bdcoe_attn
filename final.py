...
def enter():
    ...
    datef = Label(frame4, text=day + "-" + mont[month] + "-" + year + "  |  ", fg="gray18", bg="gray89", width=55,
    ...
    global message1
    message1 = Label(frame2, text="1)Take Images      2)Save Profile", bg="gray22", fg="white", width=39, height=1,
